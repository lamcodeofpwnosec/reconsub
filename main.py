...
def main():
    ...
    api_key_securitytrails = "WlKolniwthGihui29-yMAq7h57sBAFuj"  # API key SecurityTrails Anda
    api_key_virustotal = "0694d0a8b98c5b3ad29372845368467ad9dc0cd55b638af226c7d73fc137bb1e"  # API key VirusTotal Anda
    api_key_shodan = "U5Ld0rbM56LyEll5NdB80EHrXJWmCKzG"  # API key Shodan Anda
